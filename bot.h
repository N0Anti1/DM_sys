...
// je verrais plutôt :
// Elle choisi si elle joue verticalement (random booléen)
// Ensuite elle regarde si elle peut jouer sur la ligne désignée
// Si oui elle choisie aléatoirement une case à avancer
void bot_turn2(bot_t* ia, board_t* b, int highlighted_line);
